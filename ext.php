...
class ext extends base
{
	...
	*/
	public function is_enableable()
	{
		...
		$is_enableable = phpbb_version_compare(PHPBB_VERSION, '3.3.0-RC1', '>=');
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/mergeusers');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/mergeusers', 'ext_enable_error');
			}
		}
